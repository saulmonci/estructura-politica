...
describe('PersonaFormModal', () => {
    it('renders fields based on entityType', async () => {
        let modalRef;
        const TestComponent = () => {
            modalRef = useRef(null);
            return <PersonaFormModal ref={modalRef} entityType="RD" />;
        };

        render(<TestComponent />);
        
        await waitFor(() => {
            expect(screen.getByText(/REGISTRO DE Representante Demarcación/i)).toBeInTheDocument();
