...
const PersonaFormModal = forwardRef(
    ({ onSuccess, entityType = 'RD', availableRds = [], availablePresidentes = [] }, ref) => {
                    ...
                    render: (props) => {
                        ...
                        const requiresParent =
                            ((entityType === 'Representante' || entityType === 'Coordinador') &&
                                ['admin', 'superadmin', 'superuser'].includes(userRole)) ||
                            (entityType === 'Operador' &&
                                ['presidente', 'coordinador_distrito', 'admin', 'superadmin', 'superuser'].includes(
                                    userRole
                                )) ||
                            (entityType === 'Promotor' &&
                                [
                        ...
                        const isDisabled =
                            ...
                            requiresParent &&
                            (entityType === 'Representante' || entityType === 'Coordinador'
                                ? availablePresidentes.length === 0
                                : availableRds.length === 0);
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h2 className="m-0 text-xl font-bold tracking-wide uppercase">
                                {editId ? 'EDICIÓN DE' : 'REGISTRO DE'}{' '}
                                {entityType === 'Coordinador'
                                    ? 'Coordinador de Distrito'
                                    : entityType === 'RD' || entityType === 'Representante'
                                      ? 'Representante Demarcación'
                                      : entityType === 'Operador'
                                        ? 'Operador Político'
                                        : 'Promotor'}
                            </h2>
                            <p className="m-0 text-sm text-gray-300">Estructura Política y Control Territorial</p>
                        </div>
                    </div>
                        ...
                        <Col xs={24} lg={15}>
                                    ...
                                    if (data.demarcacion_id) {
                                        ...
                                        try {
                                            const secRes = await axios.get(
                                                `/catalogos/demarcaciones/${demId}/secciones`
                                            );
                                            ...
                                            if (data.seccion_electoral) {
                                                ...
                                                const foundSec = secList.find(
                                                    (s) =>
                                                        String(s.numero) === rawSec || String(s.numero) === trimmedSec
                                                );
                                                if (foundSec) {
                            ...
                            <div className="mt-4">
                                {(() => {
                                    ...
                                    const parentLabel =
                                        entityType === 'Representante' || entityType === 'Coordinador'
                                            ? 'Presidente a cargo'
                                            : entityType === 'Operador'
                                              ? 'Representante de Demarcación (RD)'
                                              : 'Operador';

                                    return requiresParent ? (
                                        <Row
                                            gutter={16}
                                            className="mb-4 rounded-md border border-blue-100 bg-blue-50 p-3"
                                        >
                                            <Col span={24}>
                                                <ProFormSelect
                                                    name="parent_id"
                                ...
                                <Row gutter={16}>
                                    <Col xs={24} md={8}>
                                        <ProFormText
                                            ...
                                            fieldProps={{ prefix: <UserOutlined className="mr-2 text-gray-400" /> }}
                                        />
                                    </Col>
                                    <Col xs={24} md={8}>
                                        <ProFormText
                                ...
                                <Row gutter={16}>
                                    ...
                                    <Col xs={12} md={6}>
                                        <ProFormText
                                            ...
                                            fieldProps={{
                                                prefix: <span className="mr-2 font-bold text-gray-400">#</span>,
                                            }}
                                        />
                                    </Col>
                                    <Col xs={12} md={6}>
                                ...
                                <Row gutter={16}>
                                    <Col xs={24} md={12}>
                                        <ProFormText
                                            ...
                                            rules={[{ required: true, message: 'Requerido' }]}
                                            fieldProps={{ prefix: <BankOutlined className="mr-2 text-gray-400" /> }}
                                        />
                                    </Col>
                                    <Col xs={24} md={12}>
                                        <ProFormText
                                            ...
                                            rules={[
                                                ...
                                                {
                                                    pattern: /^[0-9]{5}$/,
                                                    message: 'Debe contener exactamente 5 números',
                                                },
                                            ]}
                                            fieldProps={{
                                                prefix: <span className="mr-2 font-bold text-gray-400">CP</span>,
                                                maxLength: 5,
                                                onKeyPress: (event) => {
                                        ...
                                        <Col span={24}>
                                            <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
                                                ...
                                                <p className="mb-3 text-sm text-blue-700">
                                                    Selecciona la demarcación de la cual este Representante será
                                                    responsable. Esta demarcación determinará los datos que el RD podrá
                                                    visualizar.
                                                </p>
                                                <ProFormSelect
                                                    ...
                                                    rules={[{ required: true, message: 'Requerido' }]}
                                                    fieldProps={{
                                                        prefix: <EnvironmentOutlined className="mr-2 text-blue-500" />,
                                ...
                                <Row gutter={16}>
                                    <Col xs={24} md={12}>
                                        <ProFormText
                                            ...
                                            rules={[
                                                ...
                                                {
                                                    pattern: /^[0-9]{10}$/,
                                                    message: 'Debe contener exactamente 10 números',
                                                },
                                            ]}
                                            fieldProps={{
                                    ...
                                    <Col xs={24} md={12}>
                                        <ProFormText
                                            ...
                                            fieldProps={{ prefix: <MailOutlined className="mr-2 text-gray-400" /> }}
                                        />
                                    </Col>
                                </Row>
                                ...
                                <Alert
                                    ...
                                    type="success"
                                    showIcon
                                    className="mt-0 border-green-200 bg-green-50"
                                />
                            </div>
                        </Col>
                                ...
                                <Alert
                                    description={
                                        <span className="text-sm text-blue-800">
                                            Fotografía actual de la persona. Esto nos ayuda a identificarla fácilmente
                                            en campo.
                                        </span>
                                    }
                                    type="info"
                                ...
                                <div className="flex min-h-[260px] flex-col items-center justify-center rounded-xl border-2 border-dashed border-gray-300 bg-gray-50 p-4 text-center">
                                    ...
                                    {fileList.length > 0 ? (
                                        ...
                                        <>
                                            ...
                                            <p className="mt-2 mb-0 text-xs text-gray-400">Max: 4MB</p>
                                        </>
                                    )}
                                </div>
