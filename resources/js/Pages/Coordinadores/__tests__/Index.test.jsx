...
import CoordinadoresIndex from '../Index';
...
describe('Coordinadores Index Page', () => {
    it('renders the coordinadores page', () => {
        render(<CoordinadoresIndex />);
        
        expect(screen.getByText('Coordinadores de Distrito')).toBeInTheDocument();
        expect(screen.getByTestId('app-table-/coordinadores')).toBeInTheDocument();
        expect(screen.getByRole('button', { name: /Agregar Coordinador/i })).toBeInTheDocument();
