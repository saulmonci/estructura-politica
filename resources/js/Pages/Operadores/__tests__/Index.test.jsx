...
import OperadoresIndex from '../Index';
...
describe('Operadores Index Page', () => {
    it('renders the operadores page', () => {
        render(<OperadoresIndex />);
        
        expect(screen.getByText('Operadores Políticos')).toBeInTheDocument();
        expect(screen.getByTestId('app-table-/operadores')).toBeInTheDocument();
        expect(screen.getByRole('button', { name: /Agregar Operador/i })).toBeInTheDocument();
    });
});
